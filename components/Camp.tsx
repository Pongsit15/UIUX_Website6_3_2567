...
const CampSite = ({backgroundImage,title,subitle,peopleJoined,}:
  CampSite) => {
  return (
...
function Camp() {
  return (
    ...
    relative flex flex-col py-10 lg:py-10 xl:mb-20'>
      <div className='hide-scrollber flex h-[340px] w-full items-start
